...
//-------------------------------- all post requests ------------------------------------
router.post(
  "/RegisterClientsAsJON",
  clientController.RegisterClientsAsJobOrderNumber
);
router.post(
  "/RegisterClientAsPhone",
  clientController.RegisterClientAsPhoneNumber
);
...
router.post(
  "/requestCallbacks",
  checkClientServiceExist,
  clientController.RequestCallbacks
);
...
router.post(
  "/imediateServiceRequest",
  checkClientServiceExist,
  clientController.imediateServiceRequest
);
...
router.post(
  "/createReferal",
  verifyToken("client"),
  clientController.referalUser
);
router.get(
  "/getClientReferalByJobOrderNumber/:jobOrderNumber",
  verifyToken("client"),
  clientController.getAllReferalByJobOrderNumber
);
...
// ------------------------all get Requests ----------------------------------------
router.get(
  "/clientDetail/:JobOrderNumber",
  verifyToken("client"),
  clientController.getClientDetail
);
router.get(
  "/clientCallbacks/:JobOrderNumber",
  verifyToken("client"),
  clientController.getAllClientCallbacks
);
router.get(
  "/clientServices/:JobOrderNumber",
  verifyToken("client"),
  clientController.getAllClientServices
);

router.get(
  "/clientAllJONs/:PhoneNumber",
  verifyToken("client"),
  clientController.GetAllJobOrderNumberByClientPhoneNumber
);
//-------------------------verify-----------------------------------------------------
...
// ----------- 17/04/2024 Preet -------------------------------
router.get(
  "/fetchClientServiceHistory/:JobOrderNumber",
  clientController.fetchClientServiceHistory
);
...
// ------------------------20/05/2024 by preet --------------------------------
router.get(
  "/getClientCurentActiveService/:JobOrderNumber",
  clientController.getCurrentScheduleService
);

router.get(
  "/gettrackerdetails/:trackerId",
  clientController.getStepsAndEnggDetail
);

//---------------------------- embeded by preet 24/05/2024---------------------------------------------------------------
router.post("/clientPayment", clientController.clientPayment);

router.get("/getMembershipData", clientController.getMembershipFeatuesDetails);
router.get(
  "/getMembershipDiscount/:JobOrderNumber",
  clientController.getMembershipDiscount
);

router.get(
  "/checkpaymentstatusandmakeinvoice/:JobOrderNumber",
  clientController.checkPaymentStatusAndMakeInvoice
);

router.post(
  "/registerFirebaseToken",
  clientController.firebaseTokenForPushNotificationPurpose
);
