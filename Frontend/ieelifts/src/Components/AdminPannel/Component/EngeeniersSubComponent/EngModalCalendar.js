...
const EngModalCalendar = ({ setTodayDate, toggleModal }) => {
  ...
  const handleClickOutside = (event) => {
    if (ACalendarRef.current && !ACalendarRef.current.contains(event.target)) {
...
export default EngModalCalendar;
